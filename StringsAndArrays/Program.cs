namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The length of '{0}' is {1}", helloWorld, stringLength);

            // 1.2 Print the first and the last character of the string.
            string frst = helloWorld.Substring(0, 1);
            char lst = helloWorld[helloWorld.Length-1];
            ...
            Console.WriteLine("Words in the helloWorld string:");
